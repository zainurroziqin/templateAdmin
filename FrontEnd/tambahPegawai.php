...
if(isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO staff (NIP, Nama, Jabatan) VALUES('$nip', '$nama', '$jabatan')";
...
<div class="row no-gutters mt-5">
  ...
  <div class="col-md-10 p-5 pt-2">
    <h3><i class="fas fa-tachometer mr-2"></i>Tambah Pegawai</h3><hr>
    <div class="row text-white">
        <div class="card col-md-7 mx-auto p-5">
            ...
            <form  class= "user" method="POST" action="tambahPegawai.php">
